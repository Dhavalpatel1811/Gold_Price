# -*- coding: utf-8 -*-
"""
Archived early prototype: pulls gold futures data directly from yfinance
and trains a simpler single-feature LSTM. Superseded by
models/train_lstm.py, which uses the curated feature set in
data/processed/gold_features.xlsx. Kept for reference only.
"""
